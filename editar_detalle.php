        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <h4 class=" mb-0 text-gray-800">Orden Detalle</h4>
                            ...
                            <div>
                                <form action="utilidades/editar-orden.php?id_orden=<?php echo base64_encode($row['Num_Item']) ?>" method="POST">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input value="<?php echo $row['Desc_Item'] ?>" type="text" class="form-control" name="desc_orden" id="descripcion" aria-describedby="emailHelp" disabled autocomplete="off">
                                        <small id="emailHelp" class="form-text text-muted"></small>
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleInputPassword1">Cantidad</label>
                                        <input value="<?php echo $row['Cnt_Item'] ?>" type="text" class="form-control" name="cant_orden" id="cantidad" autocomplete="off" disabled>
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleInputPassword1">Precio</label>
                                        <input type="text" class="form-control" name="precio_orden" value="<?php echo $row['Pre_Item']; ?>" id="precio" disabled>
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleInputPassword1">Total</label>
                                        <input type="text" class="form-control" name="total_orden" value="<?php echo $row['Tot_Item']; ?>" id="total" disabled>
                                    </div>
                                        <?php } ?>
                                        </select>
