...
if (empty(base64_decode($_REQUEST['id']))) {
                ...
                <div class="container-fluid">
                    ...
                    ?>
                        ...
                        <div class="card shadow mb-4 usuario-st" style="padding: 2rem 25rem 6rem 25rem">
                            <div>
                                <form action="utilidades/editar-usuarios.php?id_usuario=<?php echo base64_encode($row['id']) ?>" method="POST">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="rol" name="rol-usuario" disabled>
                                        <?php } ?>
                                        <?php
                                        $sql2 = "SELECT id_roles, nom_rol, rol FROM usuarios INNER JOIN roles ON roles.id_roles = usuarios.rol WHERE id = $id";
                                        $sql3 = "SELECT * from roles";
                                        $query3 = mysqli_query($con, $sql3);
                                        $query2 = mysqli_query($con, $sql2);
                                        while ($row3 = mysqli_fetch_array($query3)) {
                                            echo '<option value="' . $row3['id_roles'] . '">' . $row3['nom_rol'] . '</option>';
                                        }
                                        ?>
