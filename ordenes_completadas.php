                            ...
                            <div class="cont-izquierdo">
                                <form action="" method="Post">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input value="<?php echo $result2['Nom_User'] ?>" type="text" class="form-control responsable" name="" id="" autocomplete="off" disabled>
                                        <input style="display: none" value="<?php echo $result2['Nom_User'] ?>" type="text" class="form-control responsable" name="responsable" id="responsable" autocomplete="off">
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleInput">Autorizada por:</label>
                                        <input value="<?php echo $result2['autorizado'] ?>" type="text" class="form-control responsable" name="responsable2" id="responsable2" autocomplete="off" disabled>
                                    </div>
